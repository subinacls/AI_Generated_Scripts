# This is the flask application interface
...
# module import which will consume contents of a dir
def import_all_py_files(directory):
...
import_all_py_files(os.path.join(current_directory, "modules"))
...
# Falsk configuration and routing section
app = Flask(__name__)
